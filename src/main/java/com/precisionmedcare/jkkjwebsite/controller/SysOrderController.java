...
public class SysOrderController {
    ...
    @PostMapping("buy")
    public void saveOrder(@RequestBody Map<String, Object> map, HttpServletRequest request, HttpServletResponse response) throws Exception {
//        @RequestParam("userid") String userid, @RequestParam("nmnid") String nmnid

        String orderTime, userId, userName, payType, nmnName, nmnPrice, nmnNumber, nmnTotal, nmnId, codeUrl = "";
        ...
        if (!map.isEmpty()) {
            ...
            if ("".equals(userId)) {
                ...
                //保存UserDetail
                sysUserDetailService.saveUserDetail(nmnNmnOrderVo);
            }
            //保存订单
            for (Object product : productList) {
                ...
                sysNmnOrderService.saveNmnWeChatOrder(nmnNmnOrderVo);
            }
            //登陆后支付
            if ("weChatPay".equals(payType)) {
                //微信支付 保存订单同时返回codeUrl
    ...
    public NmnNmnOrderVo saveNmnOrderVo(Map<String,Object> map,HttpServletRequest request,String OutTradeNo){
        String userAddress, userIdCard, userPhone, email, totalFee;
//        String generalTitle = "nmn保健品";
