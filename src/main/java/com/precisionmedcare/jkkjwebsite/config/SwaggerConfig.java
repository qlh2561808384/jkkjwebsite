...
public class SwaggerConfig {
    ...
    public Docket docket() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                 ...
                 */
                .apis(RequestHandlerSelectors.basePackage("com.precisionmedcare.jkkjwebsite.controller"))
                /**
                 * paths() 扫描过滤方式
                 *      any过滤全部
                 *      none不过滤
...
//                .paths(PathSelectors.ant("/login/**"))
    ...
    public ApiInfo apiInfo(){
        /*作者信息*/
//        Contact contact = new Contact("qlh", "http://baidu.com", "qlh2561808384@163.com");
